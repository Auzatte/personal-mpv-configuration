...
Colorspace management settings optimized for my display and adjusted for my personal preferences: Xiaomi G Pro 27i |100% SRGB, 100% AdobeRGB, 99% DCI-P3, 86% BT.2020| /\SDR Peak ~1037nits, HDR Peak ~1500nits/\ 1152 Local Dimming Zones

Display is running at VSR 4K 3840x2160@180Hz 10bit

This configuration is being used with the latest git mpv build from (https://github.com/zhongfly/mpv-winbuild) and SmoothVideoPlayer4 @ X4 Source ~95.904fps.
