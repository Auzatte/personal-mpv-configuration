...
Tuned for my personal desktop: Ryzen 5800X3D -30 CO All Core /\ Radeon RX6950XT GFXClk OC @~2772mhz | MEMClk OC @~2400Mhz Fast Timings | /\ Corsair Vengeance 32GB OC @1.4V @3600Mhz CL16 tRCD19 tRP19 tRAS37
...
Computer\HKEY_CURRENT_USER\Software\Microsoft\DirectX\UserGpuPreferences | Value Name: C:\Users\Admin\Documents\mpv\mpv.exe Value Data: SwapEffectUpgradeEnable=1;AutoHDREnable=48;GpuPreference=2;VRROptimizeEnable=0;SwapEffectUpgradeCache=1;AutoColorManagementSupported=1;AutoColorManagementEnabled=1;

mpv.exe set to Run as Administrator, & Override High DPI scaling behavior. Scaling performed by: Application
