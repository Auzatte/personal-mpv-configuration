...
Tuned for my personal desktop: Ryzen 5800X3D -30 CO All Core /\ Radeon RX6950XT GFXClk OC @~2833mhz | MEMClk OC @~2400Mhz Fast Timings | Fclk OC @~2150Mhz | UV @~1162mV /\ Corsair Vengeance 32GB OC @1.4V @3600Mhz CL16 tRCD19 tRP19 tRAS37

Colorspace management settings optimized for my display and adjusted for my personal preferences: Corsair Xeneon 32QHD165 100% AdobeRGB | 100% SRGB | 98% DCI-P3 | 86% BT.2020 /\ Using AMD Virtual Super Resolution and GPU-scaling /\ Display is running at 4k 3840x2160@165Hz 8bit+FRC ACM Dithering for 10bit DCI-P3 and AMD Vivid Gaming to counter the washed out colors /\
...
Computer\HKEY_CURRENT_USER\Software\Microsoft\DirectX\UserGpuPreferences | Value Name: C:\Users\Admin\Documents\mpv\mpv.exe Value Data: SwapEffectUpgradeEnable=257;AutoHDREnable=48;VRROptimizeEnable=0;SwapEffectUpgradeCache=1;GpuPreference=2;DisableMultiplaneOverlay=1;AutoColorManagementSupported=1;AutoColorManagementEnabled=1;
