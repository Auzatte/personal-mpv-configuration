...
The two configurations in the repo are being used with the latest mpv-git release and with SmoothVideoPlayer4 interpolation @5x23.976fps 119.880fps. Some drivers work better with DirectX12 and some better with Vulkan which is why there are two.
